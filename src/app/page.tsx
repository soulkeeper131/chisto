      ...
      <div style={{ textAlign: "center", maxWidth: 480, width: "100%" }}>
        ...
        <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap", marginBottom: 32 }}>
          <div style={{
            ...
            boxShadow: "0 8px 24px rgba(61,37,75,.08)", minWidth: 160, cursor: "pointer",
          }}
          onClick={() => { setUser("u_admin1"); setEntered(true); }}>
          ...
          onClick={() => { setUser("u_ins1"); setEntered(true); }}>
            <div style={{ fontSize: 40, marginBottom: 12 }}>📍</div>
        ...
        <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
          {[
            ...
            <button key={u.id} onClick={() => { setUser(u.id); setEntered(true); }}
              style={{ padding: "10px 18px", borderRadius: 12, border: "1px solid #E6EAF0",
                background: "#FBFCFD", fontWeight: 600, fontSize: 13, color: "#334155", cursor: "pointer",
              }}>
              <span style={{ display: "inline-block", width: 22, height: 22, borderRadius: "50%",
